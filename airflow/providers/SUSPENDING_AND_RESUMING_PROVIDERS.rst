...
* Yoy will need to update ``extra-packages-ref.rst`` and in some cases - when mentioned there explicitly
...
The fix for that is to turn the feature into optional provider feature (in the place where the excluded
